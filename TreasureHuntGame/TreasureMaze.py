...
class TreasureMaze(object):
    ...
    def observe(self):
        ...
        envstate = canvas.reshape((1, -1)) #https://keras.io/api/layers/reshaping_layers/reshape/      or  https://www.tensorflow.org/api_docs/python/tf/keras/layers/Reshape
        return envstate
    ...
    def game_status(self):
        # If the agent’s total reward goes below the minimum reward, the game is over. LIKE HITTING A WALL
